...
(2, 'Hunger Games: the ballad of songbirds and snakes', 'Francis Lawrence', 'Azione, Avventura', 165, 'USA', 2023, 'Anni prima di diventare il tirannico presidente di Panem, il diciottenne Coriolanus Snow è l ultima speranza per il buon nome della sua casata in declino: un orgogliosa famiglia caduta in disgrazia nel dopoguerra di Capitol City.','https://www.youtube.com/embed/kqAyrCadrQU?fs=1&autoplay=1','Ita','Rachel Zegler, Tom Blyth, Hunter Schafer', 1),
(3, 'Gremlins', 'Joe Dante', 'Fantastico', 111, 'USA', 1984, 'Rand Peltzer, inventore, ha trovato un regalo natalizio perfetto per suo figlio Bill: un piccolo mogwai tenero e buffo. ','https://youtu.be/X7e445RxiP4?si=FR7Ux76GK7y6XprL','Ita','Phoebe Cates, Keye Luke, Zach Galligan', 1),
